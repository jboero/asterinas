...
KUBELET_SRC=${KUBELET_REPO:-/home/jboero/code/asterinas_experiment/kubelet}/cmd/astrokube-init
K8S=${K8S_SRC:-/home/jboero/code/asterinas_experiment/kubernetes-src}
K8S_VERSION=${K8S_VERSION:-v1.35.6}
OUT=${1:-/tmp/claude-1000/-home-jboero-code-asterinas-experiment/cda31c84-d1d7-4b29-b835-799b7fecd452/scratchpad/static-bins/astrokube-kubelet}
