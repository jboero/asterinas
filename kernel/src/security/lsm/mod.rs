...
use self::hooks::{
    LsmAlienAccessHook, LsmFileAccessHook, LsmSignalAccessHook, LsmSocketConnectHook,
};
use crate::prelude::*;
...
trait LsmModule:
    LsmAlienAccessHook + LsmSignalAccessHook + LsmFileAccessHook + LsmSocketConnectHook + Sync
{
