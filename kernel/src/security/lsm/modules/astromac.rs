...
use super::super::{
    LsmFlags, LsmModule,
    hooks::{
        FileAccessContext, LsmAlienAccessHook, LsmCapabilityHook, LsmFileAccessHook,
        LsmSignalAccessHook, LsmSocketConnectHook, SignalAccessContext, SocketConnectContext,
    },
};
use crate::{
    prelude::*,
...
// astromac does not mediate capability checks; the default (permit) applies.
impl LsmCapabilityHook for AstroMacLsm {}
